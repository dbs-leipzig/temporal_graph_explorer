...
/**
 * Aggregation function similar to {@link MaxTime} but with a formatted property as result.
 */
public class FormattedMaxTime extends MaxTime {
   ...
   */
  public FormattedMaxTime(String aggregatePropertyKey, TimeDimension dimension, TimeDimension.Field field,
